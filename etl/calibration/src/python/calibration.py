...
from io import save_pickle, save_csv, get_data, save_fit_plot, save_txt, \
    save_target_pred
...
def param_optimization(grid, col_predict, cv_k=5, n_part=.1,
                       ...
                       save=True):
    x, x_all, y, _ = load_data(col_predict, n_part, train_file, verbose)
...
def load_data(col_predict, n_part, train_file, verbose):
