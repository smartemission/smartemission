...
ALTER TABLE smartem_raw.timeseries  ALTER COLUMN unique_id TYPE character varying (64);
ALTER TABLE smartem_raw.harvester_progress  ALTER COLUMN device_id TYPE numeric;
ALTER TABLE smartem_raw.harvester_progress  ALTER COLUMN unique_id TYPE character varying (64);
...
ALTER TABLE smartem_rt.last_device_output  ALTER COLUMN unique_id TYPE character varying (64);
