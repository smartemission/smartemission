...
python airsenseur_staclear.py https://data.smartemission.nl/gost/v1.0/ ${sta_user_extern} ${sta_password_extern}
...
function query() {
    ...
    curl -G 'https://data.smartemission.nl/influxdb/query?pretty=true' \
