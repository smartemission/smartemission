...
NB you may want to change the admin password to the default, after installation:
https://wiki.52north.org/bin/view/SensorWeb/SosFAQ#How_to_apply_Tomcat_HTTP_basic_a
INSERT OR REPLACE INTO administrator_user(id, username, password) VALUES (1, 'admin', '<hashvalue>');
